...
def show_landing():
    ...
    st.markdown("""<style>header[data-testid="stHeader"]{display:none!important}div[data-testid="stToolbar"]{display:none!important}div[data-testid="stDecoration"]{display:none!important}#MainMenu{display:none!important}footer{display:none!important}section[data-testid="stSidebar"]{display:none!important}div.block-container{padding:0!important;max-width:100%!important}.stApp{background:#2d6a7a!important}iframe{border:none!important}.hidden-btn{height:1px;overflow:hidden;margin:0;padding:0;border:0;opacity:0.01}</style>""", unsafe_allow_html=True)
