...
def show_landing():
    ...
    st.markdown("""<style>header[data-testid="stHeader"]{display:none!important}div[data-testid="stToolbar"]{display:none!important}div[data-testid="stDecoration"]{display:none!important}#MainMenu{display:none!important}footer{display:none!important}section[data-testid="stSidebar"]{display:none!important}div.block-container{padding:0!important;max-width:100%!important}.stApp{background:#0d1117!important}iframe{border:none!important}.hidden-btn{height:0;overflow:hidden;margin:0;padding:0;border:0;opacity:0;pointer-events:none}</style>""", unsafe_allow_html=True)
