...
# ============================================================
# LANDING PAGE (with ships and waves via components.html)
# ============================================================
def show_landing():
...
:root{--gold:#c5993e;--gold-light:#d4b06a;--cream:#faf6ee}
html,body{width:100%;height:100%;overflow:hidden;background:#0d1117}
.scene{position:fixed;inset:0;background:linear-gradient(180deg,#0d1117 0%,#1a2332 35%,#1b3a4b 65%,#2d6a7a 100%)}
.stars{position:absolute;top:0;left:0;right:0;height:45%;
  background:radial-gradient(1px 1px at 8% 12%,rgba(255,255,255,0.7) 50%,transparent 100%),radial-gradient(1.5px 1.5px at 22% 25%,rgba(255,255,255,0.5) 50%,transparent 100%),radial-gradient(1px 1px at 35% 8%,rgba(255,255,255,0.6) 50%,transparent 100%),radial-gradient(1px 1px at 52% 18%,rgba(255,255,255,0.4) 50%,transparent 100%),radial-gradient(1.5px 1.5px at 67% 22%,rgba(255,255,255,0.7) 50%,transparent 100%),radial-gradient(1px 1px at 78% 10%,rgba(255,255,255,0.5) 50%,transparent 100%);
  animation:twinkle 4s ease-in-out infinite alternate}
@keyframes twinkle{0%{opacity:0.5}100%{opacity:1}}
.sea{position:absolute;bottom:0;left:0;right:0;height:45%;overflow:hidden}
.sea svg{position:absolute;bottom:0;width:100%;height:100%}
.big-ship{position:absolute;bottom:15%;z-index:6;opacity:0;animation:bsA 2s 1s ease forwards,bsS 28s 1s linear infinite}
...
.content{position:relative;z-index:10;display:flex;flex-direction:column;align-items:center;justify-content:center;height:100vh;text-align:center;padding:1.5rem}
...
<div class="scene">
  ...
  <svg class="compass" viewBox="0 0 100 100" fill="none"><circle cx="50" cy="50" r="45" stroke="#c5993e" stroke-width="0.5" opacity="0.5"/><circle cx="50" cy="50" r="38" stroke="#c5993e" stroke-width="0.3" opacity="0.3"/><line x1="50" y1="8" x2="50" y2="92" stroke="#c5993e" stroke-width="0.5" opacity="0.4"/><line x1="8" y1="50" x2="92" y2="50" stroke="#c5993e" stroke-width="0.5" opacity="0.4"/><polygon points="50,12 46,50 54,50" fill="#c5993e" opacity="0.6"/><polygon points="50,88 46,50 54,50" fill="#c5993e" opacity="0.25"/></svg>
  <div class="content">
    LOGO_PLACEHOLDER
    <h1 style="font-family:Playfair Display,serif;font-size:clamp(2.5rem,6vw,4.2rem);font-weight:700;color:var(--cream);line-height:1.1;opacity:0;animation:fU 1s 0.6s ease forwards">Voyage across the<br><em style="font-style:italic;color:var(--gold-light);font-weight:400">Mediterranean</em></h1>
    <p style="font-family:Playfair Display,serif;font-size:clamp(1.1rem,2.5vw,1.6rem);font-weight:400;font-style:italic;color:rgba(212,176,106,0.7);opacity:0;animation:fU 1s 0.85s ease forwards;margin-top:0.6rem">Are you ready to set sail?</p>
    <p style="font-family:Cormorant Garamond,serif;font-size:clamp(0.9rem,1.8vw,1.15rem);font-weight:300;font-style:italic;color:rgba(244,239,230,0.45);max-width:540px;line-height:1.6;opacity:0;animation:fU 1s 1s ease forwards;margin:0.6rem auto 0">Discover 18th &amp; 19th century travelogues through sentiment analysis and CLIP-powered illustration classification.</p>
    <div style="display:flex;gap:2.5rem;justify-content:center;margin-top:1.4rem;opacity:0;animation:fU 1s 1.1s ease forwards">
      <div style="text-align:center"><div style="font-family:Playfair Display,serif;font-size:1.5rem;font-weight:700;color:var(--gold)">140+</div><div style="font-family:DM Sans,sans-serif;font-size:0.65rem;letter-spacing:1.5px;text-transform:uppercase;color:rgba(244,239,230,0.4);margin-top:2px">Travelogues</div></div>
      <div style="text-align:center"><div style="font-family:Playfair Display,serif;font-size:1.5rem;font-weight:700;color:var(--gold)">200+</div><div style="font-family:DM Sans,sans-serif;font-size:0.65rem;letter-spacing:1.5px;text-transform:uppercase;color:rgba(244,239,230,0.4);margin-top:2px">Routes</div></div>
      <div style="text-align:center"><div style="font-family:Playfair Display,serif;font-size:1.5rem;font-weight:700;color:var(--gold)">700+</div><div style="font-family:DM Sans,sans-serif;font-size:0.65rem;letter-spacing:1.5px;text-transform:uppercase;color:rgba(244,239,230,0.4);margin-top:2px">Illustrations</div></div>
    </div>
    <div style="display:flex;align-items:center;gap:12px;justify-content:center;margin:1.2rem auto 0;opacity:0;animation:fU 1s 1.2s ease forwards"><span style="width:50px;height:1px;background:var(--gold);opacity:0.3;display:inline-block"></span><span style="width:5px;height:5px;background:var(--gold);transform:rotate(45deg);opacity:0.5;display:inline-block"></span><span style="width:50px;height:1px;background:var(--gold);opacity:0.3;display:inline-block"></span></div>
  </div>
</div>
""".replace("LOGO_PLACEHOLDER", logo_tag)
    ...
    div.stButton > button{
        ...
        font-size:0.85rem!important;letter-spacing:3px!important;
